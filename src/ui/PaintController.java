...
public class PaintController {
	...
	/**
	 * This method initializes the options to choose the pencil size and sets the
	 * pane to enable the user to paint or erase over it.
	 */
	@FXML
	...
	/**
	 * This method allows to save the drawn image in the specified path. Pre: the
	 * specified path has to exist in the file system. Post: The image will be saved
	 * successfully.
	 */
	public void onSave() {
		try {
